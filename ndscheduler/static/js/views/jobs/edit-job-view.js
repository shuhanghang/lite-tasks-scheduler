  ...
  return Backbone.View.extend({
    ...
    bindModalPopupEvent: function() {
      $('#edit-job-modal').on('show.bs.modal', _.bind(function(e) {
        ...
        $('#edit-input-job-config-bind').val($button.data('job-config')).trigger('change');
    ...
    bindEditJobConfirmClickEvent: function() {
      ...
      editConfirmButton.on('click', _.bind(function(e) {
        ...
        var jobConf = $('#edit-input-job-config-bind').val();
        ...
        if (jobConf.trim() === '') {
          utils.alertError('Please fill in job conf class');
          return;
        }
