...
require.config({
  paths: {
    ...
    'configure-job-view': 'views/jobs/configure-job-view',
    ...
    'job-row-config': 'templates/job-row-config.html',
  },
...
define(['utils',
  ...
  return Backbone.View.extend({
    ...
    render: function() {
      ...
      var data = [];
      // Build up data to pass to template
      _.each(jobs, function(job) {
        ...
        data.push([
          _.template(JobRowNameHtml)({
            ...
            'job_config_bind': _.escape(jobObj.job_config_bind),
          ...
          _.template(JobRowConfigHtml)({
            'job_id': jobObj.job_id,
            'job_name': _.escape(jobObj.name),
            'job_config_bind':  _.escape(jobObj.job_config_bind),
            'job_config_content': _.escape(jobObj.job_config_content)
          }),
