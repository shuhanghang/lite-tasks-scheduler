...
class BaseScheduler (apscheduler_tornado.TornadoScheduler):
    ...
    @classmethod
    def run_job(cls, job_class_path, _, job_id, db_class_path, db_config,
    ...
    def run_scheduler_job(cls, job_class, job_id, execution_id, datastore, *args, **kwargs):
        ...
        try:
            ...
            result_json = json.dumps(result, indent=4, sort_keys=False)
    ...
    def add_scheduler_job(self, job_class_string, job_config_class_bind, name, pub_args=None,
        ...
        arguments = [job_class_string, job_config_class_bind, job_id, self.datastore_class_path,
    ...
    def modify_scheduler_job(self, job_id, **kwargs):
        ...
        if 'job_class_string' in kwargs or 'pub_args' in kwargs:
            ...
            if 'job_config_bind' in kwargs:
                args[1] = kwargs['job_config_bind']
                del kwargs['job_config_bind']
