...
class SchedulerManager:
    ...
    # Manage jobs
    #
    def add_job(self, job_class_string, job_config_bind, name, pub_args=None, month=None,
        ...
        :rtype: str
        """
        return self.sched.add_scheduler_job(job_class_string, job_config_bind, name, pub_args, month, day_of_week,
