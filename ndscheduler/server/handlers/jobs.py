...
class Handler(base.BaseHandler):
    ...
    def _build_job_dict(self, job):
        ...
        if job.next_run_time:
            ...
            next_run_time = ''
        job_config_bind_string = utils.get_job_config_bind_string(job)
        return_dict = {
            'job_id': job.id,
            'name': job.name,
            'next_run_time': next_run_time,
            'job_class_string': utils.get_job_name(job),
            'job_config_bind': job_config_bind_string,
    ...
    def _validate_post_data(self):
        ...
        """
        all_required_fields = ['name', 'job_class_string', 'job_config_bind']
